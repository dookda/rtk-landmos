...
let changeColorMarker = (id, val) => {
    // console.log(val);
    let staLatlon;
    id == '01' ? staLatlon = [18.30473347, 99.73947427] : null;
    id == '02' ? staLatlon = [18.30472336, 99.7394922] : null;
    id == '03' ? staLatlon = [18.30483396, 99.73956838] : null;
    id == '04' ? staLatlon = [18.79533265, 98.95291733] : null;
    id == '05' ? staLatlon = [18.37677726, 99.7233494] : null;
    id == '06' ? staLatlon = [18.79533311, 98.95300434] : null;
    id == '07' ? staLatlon = [18.37680237, 99.72599941] : null;
    id == '08' ? staLatlon = [18.79534497, 98.95291226] : null;
    id == '09' ? staLatlon = [18.3033678, 99.73275609] : null;
    id == '10' ? staLatlon = [18.3774593, 99.72678206] : null;
